...
const { listBasenames, ensureDir, copyFile, copyDirectory, readCustomDroidsSetting, downloadToFile } = require('./fs-utils');
      ...
      for (const item of plan.skills) {
        ...
        try {
          if (item.srcType === 'local') {
            ...
            // Remote skills should be filtered out by marketplace planner
            // This is a defensive check in case they somehow make it here
            if (confirmedArgs.verbose) console.log(`skip   ${item.name} (remote skills not supported)`);
            result = 'skipped';
          }
        } catch (e) {
          result = 'skipped';
