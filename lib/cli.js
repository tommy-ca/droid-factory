      ...
      for (const item of plan.skills) {
        ...
        try {
          if (item.srcType === 'local') {
            ...
            // For remote skills, we'd need to download the entire directory
            // This is complex and requires archiving - skip for now
            if (confirmedArgs.verbose) console.log(`skip   ${item.name} (remote skills not yet supported)`);
            result = 'skipped';
          }
        } catch (e) {
          result = 'skipped';
